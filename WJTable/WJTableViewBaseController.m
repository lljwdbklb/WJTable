...
#import "WJTableViewBaseController.h"

#import "WJTable.h"

@interface WJTableViewBaseController ()
@property (strong, nonatomic) NSValue *targetRect;
@end


@implementation WJTableViewBaseController
- (void)viewDidLoad {
    [super viewDidLoad];
    if (!self.tableView) {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (self.sections) {
        ...
        if (s.isStroyboard) {
            cell = [tableView dequeueReusableCellWithIdentifier:NSStringFromClass(s.cellClass) forIndexPath:indexPath];
        } else {
            cell = [tableView dequeueReusableCellWithIdentifier:NSStringFromClass(s.cellClass)];
            if (!cell) {
                cell = [[WJTableViewCell alloc]initWithStyle:UITableViewCellStyleSubtitle reuseIdentifier:NSStringFromClass(s.cellClass)];
            }
        }
